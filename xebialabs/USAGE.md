...
2. Go to XL Release, look for the "dan-gcp-test-ci-cd" template, and start a new release from it.
3. Once you are done, go to XL Release, look for the "dan-gcp-test-destroy" template, and start a new release from it to automatically rollback and destroy the resources you created.
